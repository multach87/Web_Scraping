...
def get_mw_list():
    ...
    wiki_url = "https://gundam.fandom.com/wiki/Special:BrowseData/Mobile_Weapons?limit=20&offset=2039&_cat=Mobile_Weapons"
    ...
    # store the links
    return mw_links
"""for link in soup_response.find_all(class_="smw-column").find_all("a"):
        l = link.get("href")
        if l not in mw_links:
            mw_links.append(l)
    """
